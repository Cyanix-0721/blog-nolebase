...
import { githubLink, githubRepoLink, siteDescription, siteName, targetDomain } from '../metadata'
...
export default defineConfig({
  ...
  head: [
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          ['markdown', 'md', 'knowledge-base', '知识库', 'blog', 'vitepress', 'obsidian', 'notebook', 'notes', ...creatorUsernames].join(', '),
      },
    ],
  ...
  themeConfig: {
    ...
    footer: {
      message: '本站基于 <a class="footer-cc-link" target="_blank" href="https://github.com/nolebase/nolebase">nolebase</a> 搭建',
      copyright:
        '<a class="footer-cc-link" target="_blank" href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a>',
    },
    search: {
      provider: 'local',
      options: {
